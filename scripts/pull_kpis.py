...
def read_meta_health_latest():
    if not META_HEALTH_LATEST_PATH.exists():
        return None
    try:
...
def main():
    ...
    payload = {
        ...
        'summary': {
            ...
            'today_clicks': rollup_today.get('clicks'),
            'yesterday_clicks': rollup_yesterday.get('clicks'),
            'last_7d_clicks': rollup_7d.get('clicks'),
            'last_30d_clicks': rollup_30d.get('clicks'),
            'today_landing_page_views': rollup_today.get('landing_page_views'),
            'yesterday_landing_page_views': rollup_yesterday.get('landing_page_views'),
            'last_7d_landing_page_views': rollup_7d.get('landing_page_views'),
            'last_30d_landing_page_views': rollup_30d.get('landing_page_views'),
