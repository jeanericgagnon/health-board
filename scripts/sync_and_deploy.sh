...
META_CREATIVE_JOINS_LATEST="$OPS_DUP_DIR/data/meta_creative_joins_latest.json"
if [ -f "$META_CREATIVE_JOINS_LATEST" ]; then
  cp "$META_CREATIVE_JOINS_LATEST" "$REPO_DIR/data/meta_creative_joins_latest.json"
else
  echo "WARN: meta creative joins payload missing at $META_CREATIVE_JOINS_LATEST" >> "$LOG_DIR/analyze-kpis.log"
fi

# Commit only if data changed.
if ! git diff --quiet -- data/kpi_latest.json data/adsops_latest.json data/meta_rollups_latest.json data/meta_entity_rollups_latest.json data/meta_health_latest.json data/meta_creative_joins_latest.json data/analysis_latest.json data/analysis_brief.txt data/analysis_history.jsonl data/creative_metadata_latest.json data/competitor_followers_latest.json data/competitor_followers_history.jsonl data/follower_demographics_city_latest.json data/trend_intelligence_latest.json data/decision_state_latest.json data/creative_attribution_latest.json data/budget_movement_audit.json data/forecasting_tiles_latest.json data/fatigue_radar_latest.json data/winner_durability_latest.json data/flywheel_latest_metrics.json 2>/dev/null; then
  git add data/kpi_latest.json data/adsops_latest.json data/meta_rollups_latest.json data/meta_entity_rollups_latest.json data/meta_health_latest.json data/meta_creative_joins_latest.json data/analysis_latest.json data/analysis_brief.txt data/analysis_history.jsonl data/creative_metadata_latest.json data/competitor_followers_latest.json data/competitor_followers_history.jsonl data/follower_demographics_city_latest.json data/trend_intelligence_latest.json data/decision_state_latest.json data/creative_attribution_latest.json data/budget_movement_audit.json data/forecasting_tiles_latest.json data/fatigue_radar_latest.json data/winner_durability_latest.json data/flywheel_latest_metrics.json 2>/dev/null || git add data/kpi_latest.json data/analysis_latest.json data/analysis_brief.txt data/analysis_history.jsonl data/creative_metadata_latest.json data/competitor_followers_latest.json data/competitor_followers_history.jsonl data/follower_demographics_city_latest.json data/flywheel_latest_metrics.json data/meta_rollups_latest.json data/meta_entity_rollups_latest.json data/meta_health_latest.json data/meta_creative_joins_latest.json
